...
<head>
    <meta charset="utf-8">
    <title>LRPM - Surat Pengalihan Hak Cipta</title>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-8 my-3 px-3 px-sm-0  ">
                    <div class="bg-trans box-rad px-3 px-sm-4 box-reg my-5 py-4 ">
                        <h5 class="font-weight-bold text-center">SURAT PENGALIHAN HAK CIPTA</h5>
                        ...
                        <p class="text-justify">Adalah Pihak II selaku Pemegang Hak Cipta berupa <?= $karya->jenis_ciptaan ?>-<?= $karya->judul_ciptaan ?> untuk didaftarkan di Direktorat Hak Cipta, Desain Industri, Desain Tata Letak dan Sirkuit Terpadu dan Rahasia Dagang, Direktorat Jenderal Hak Kekayaan Intelektual, Kementerian Hukum dan Hak Asasi Manusia R.I.</p>
                        <p class="text-justify">Demikianlah surat pengalihan hak ini kami buat, agar dapat dipergunakan sebagaimana mestinya.</p>
                        <div class="row">
                            <div class="text-left col-6">
                                <a class="btn btn-danger" href="delete-form.php?id=<?= $id ?>">Back</a>
                            </div>
                            <div class="text-right col-6">
                                <a class="btn btn-success" href="creator-pernyataan.php?id=<?= $id ?>">Next</a>
                            </div>
                        </div>
                    </div>
                </div>
