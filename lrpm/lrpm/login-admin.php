...
if (isset($_POST["id_number"]) && isset($_POST["password"])) {
    ...
    if ($result = $mysqli->query("SELECT * FROM `tbl_users` where id_number='" . $id_number . "' AND password=MD5('" . $password . "') AND tipe='admin'")) {
    ...
    <section class="content my-5">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12  col-md-8 box-login my-3 px-3 px-sm-0  ">
                    ...
                    <center><img class="img-fluid w-25 my-1" src="resources/images/logopu2.png"/></center>
                    <br><br>
                    <center><h6>Please input the Id number and Password.</h6></center>
