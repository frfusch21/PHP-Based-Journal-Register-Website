            ...
            <div class="row justify-content-center">
                <div class="col-12  col-md-7 my-3 px-3 px-sm-0 d-flex align-items-center">
                    <div class="  px-3 py-4 w-100 text-center ">
                        <a href="view.php"><h1 class="font-weight-bold">PEMOHONAN HAK CIPTA</h1></a>
                        <h4 class="txt-main my-2 mb-4">President University</h4>

                        <form class=" py-3" id="formcari" action="view.php">
                        ...
                        <div class="row">
                            <?php $no=1; foreach ($month as $value) { ?>
                                <div class="col-3 mb-3">
                                    <a href="view2.php?year=<?=$year?>&month=<?=$no++?>" class="text-white">
